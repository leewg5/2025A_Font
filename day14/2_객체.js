...
*/
/*
const person = { 이름 : "name" , 나이 : "age", 사는곳 :"city" }
console.log(person);
*/
...
/*
// 속성명에 특수문자나 변수명 일때 경우에 대괄호 표기법 사용.
...
for(let index= 0 ; index <= Object.keys(inventory).length -1 ; index++){
    ...
    if(inventory[key] < 10) // 만약에 index번째 Key 값의 10미만이면
    console.log(key);
}
*/
...
for(let index = 0; index <= data.length -1; index++){
    ...
    const obj = data[index]; // index번째의 객체(동별 인구정보)호출
        console.log(obj);
        // *(동별)객체별 속성 값 확인
       // console.log(obj.동별);                  console.log(obj.세대수);
       // console.log(obj.세대수);                console.log(["인구수[남]"]);
