...
// 만약에 max(기록)보다 더 큰 수가 존재하면 더큰수를 max(기록)
...
for(let index = 0 ; index <= numbers.length-1; index++){
    ...
    //만약에 max보다 index번째 요소값이 더크면 max에 index번째 요소값을 대입한다.
} //for end
console.log(max);
*/
...
star은 1부터 5/4/3/2/1까지 1씩증가 ->  for(let star = 1; star <= 54321; star++)
*/
// (1) 단마다 곱 출력 / 곱마다 단 출력
/*
let output = ""
...
for(let index = 0; index <= userNames.length -1; index++){
    let value = userNames[index]; //index번째의 요소값 호출
        //console.log(value);
    if(value.indexOf('솔') != -1){
        console.log(value)
    }
}//for end
...
/*
let seatLayout = [['A1', 'A2', 'A3'], ['B1', 'B2', 'B3'], ['C1', 'C2', 'C3']];
console.log(seatLayout[0]);
console.log(seatLayout[1]);
console.log(seatLayout[2]);
